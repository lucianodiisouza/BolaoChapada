								...
								<tr>
									...
									<td>
										<center>
											...
											<?php if($linha['rodadaProcessada'] == false){ ?>
													<!-- mostrar botão de processar rodada -->
											<a href="processarRodada/index.php?id=<?php echo $linha["id"]?>" title="Processar rodada"><i class="fas fa-hourglass-half"></i></a>
													<!-- ocultar botão de processar rodada -->
											<?php } ?>
											<a href="processarRodada/rankingRodada.php?id=<?php echo $linha["id"]?>" title="ranking"><i class="fas fa-trophy"></i></a>
										</center>
									</td>
								</tr>
								<?php 
