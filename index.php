...
<body>
	...
	<div class="bg-g1 size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-35 respon1">
		...
		<span class="s1-txt3 txt-center">
			<a href="#" title="Luciano dii Souza - Desenvolvimento Web & Mobile">#</a>
		</span>
			...
			<div class="modal-subscribe where1-parent bg0 bor2 size4 p-t-54 p-b-100 p-l-15 p-r-15">
				...
				<div class="wsize1 m-lr-auto">
					<h3 class="m1-txt1 txt-center p-b-36">
						<span class="bor1 p-b-6">Inscreva-se</span>
					</h3>
					...
					<form class="contact100-form validate-form" method="POST">
						<div class="wrap-input100 m-b-10 validate-input" data-validate = "Não esqueça de colocar seu nomoe">
							<input class="s1-txt4 placeholder0 input100" type="text" name="nome" placeholder="Nome" maxlength="255">
							<span class="focus-input100"></span>
						</div>

						<div class="wrap-input100 m-b-20 validate-input" data-validate = "Insira um email válido: ex@abc.xyz">
							<input class="s1-txt4 placeholder0 input100" type="text" name="email" placeholder="Email" maxlength="255">
							<span class="focus-input100"></span>
						</div>
					...
					<p class="s1-txt5 txt-center wsize2 m-lr-auto p-t-20">
						Não se preocupe, nós também não gostamos de spam, você poderá cancelar a qualquer momento!
					</p>
				</div>
			</div>
